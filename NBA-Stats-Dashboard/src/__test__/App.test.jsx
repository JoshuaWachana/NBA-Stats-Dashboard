...
jest.mock('../components/NavMenu', () => () => <div data-testid="nav-menu-mock">NavMenu</div>);
jest.mock('../components/MainContent', () => () => <div data-testid="main-content-mock">MainContent</div>);
